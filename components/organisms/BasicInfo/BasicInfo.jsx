    ...
    return (
        ...
        <div className="flex flex-col  gap-6 md:flex-row items-center max-w-8xl">
            <div className="w-full md:w-1/2 lg:pr-32">
                <h2 className="text-4xl lg:text-5xl text-center md:text-left text-blue-900 leading-tight font-medium">Sobre Mí</h2>
                <h3
                    ...
                    Soy [Nombre del Entrenador], un entrenador personal certificado con [años de experiencia]. Mi enfoque se centra en proporcionar planes de entrenamiento personalizados que se adapten a tus necesidades.
                </h3>
